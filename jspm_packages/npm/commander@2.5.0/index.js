/* */ 
(function(process) {
  var EventEmitter = require("github:jspm/nodelibs@0.0.7/events").EventEmitter;
  ...
  Command.prototype.action = function(fn) {
    ...
    if (this._alias)
      this.parent.on(this._alias, listener);
    return this;
  };
  ...
  Command.prototype.helpInformation = function() {
    return ['', '  Usage: ' + this._name + (this._alias ? '|' + this._alias : '') + ' ' + this.usage(), '' + this.commandHelp(), '  Options:', '', '' + this.optionHelp().replace(/^/gm, '    '), '', ''].join('\n');
  };
